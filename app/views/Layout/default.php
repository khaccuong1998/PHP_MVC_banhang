        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li><a href="index.php?module=Product&action=chitiet_sp">Hot Deals</a></li>
                    <li><a href="index.php?module=Product&action=tatcasp">Categories</a></li>
                    <li><a href="index.php?module=Product&action=thanhtoan">Laptops</a></li>
